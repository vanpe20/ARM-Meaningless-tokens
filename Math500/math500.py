...
path = './dataset/Math-500/test.jsonl'

os.makedirs("Mless_release/answer", exist_ok=True)

logging.basicConfig(
    filename="./answer/math500.log",        
    filemode="a",             
...
def evaluate_pass_at3(
    ...
    logging.info(f"Pass@3 on{args.model_name} with c={args.range_c}, p={args.percentage}, the score on Math500 is: pass@3_macro: {macro}, per_task: {per_task_score}")
